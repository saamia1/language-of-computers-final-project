...
function updateAuthUI() {
  ...
  document
    ...
    .forEach(function (el) {
      el.parentElement.style.display = user ? "none" : "";
    });
  // toggle booking links
  document.querySelectorAll('a[href*="booking.py"]').forEach(function (el) {
    el.parentElement.style.display = user ? "" : "none";
  });
  // add logout link
  if (user && !document.querySelector('a[href="logout.py"]')) {
    var menu = document.querySelector("#menu ul.actions.stacked");
    if (menu) {
