...
import cgi
import os
from utils import save_booking_form
    ...
    <div id=\"wrapper\">  
        ...
        <nav id=\"menu\">  
            <ul class=\"links\">  
                ...
                <li><a href=\"booking.py\">Booking Form</a></li>
...
# Handle POST requests
    ...
    save_booking_form(date, quantity, location, notes)
    # show confirmation
    print(f"<section id=\"main\" class=\"wrapper\"><div class=\"inner\">")
    print(f"<h4>Thank you for booking {DESTINATIONS.get(location, {}).get('title', location).capitalize()} on {date} for {quantity} guest(s). We will contact you with further details soon!</h4>")
    print("<ul class=\"actions\"><li><a href=\"tours.html\" class=\"button next\">Browse More Tours</a></li></ul>")
    print("</div></section>")
